module rv_soc_dpi_tb;
  ...
  rv_perf_profiler u_perf_profiler (
    ...
    .frontend_redirect_i(u_dut.u_core.u_frontend.frontend_redirect_valid),
    ...
    .candidate_valid_i(u_dut.u_core.u_backend.cand_valid),
    .candidate_effective_mask_i(u_dut.u_core.u_backend.effective_mask),
    ...
    .rob_head_instruction_i(u_dut.u_core.u_backend.rob_head_instruction),
    .rob_head_inst_len_i(u_dut.u_core.u_backend.rob_head_instruction_length),
    .rob_head_is_load_i(u_dut.u_core.u_backend.retire_is_load[0]),
    .rob_head_is_store_i(u_dut.u_core.u_backend.retire_is_store[0]),
