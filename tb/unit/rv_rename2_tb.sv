module rv_rename2_tb;
  ...
  task automatic clear_inputs;
    ...
    src0_class               = '{default: REG_NONE};
    src1_class               = '{default: REG_NONE};
    src2_class               = '{default: REG_NONE};
    src0_arch                = '0;
    src1_arch                = '0;
    src2_arch                = '0;
    writes_destination       = '0;
    destination_class        = '{default: REG_NONE};
    destination_arch         = '0;
    commit_valid             = '0;
    commit_writes_destination = '0;
    commit_destination_class = '{default: REG_NONE};
  ...
  initial begin : p_rename_test
    ...
    destination_class   = '{REG_INT, REG_INT};
    ...
    commit_destination_class      = '{REG_INT, REG_INT};
