...
expected = {
    'check_rw': (10, 0, 1, 0x12),
    'check_rs': (11, 0x12, 1, 0x13),
    'check_rc': (12, 0x13, 1, 0x12),
    'check_rwi': (13, 0x12, 1, 5),
    'check_rsi': (14, 5, 1, 7),
    'check_rci': (15, 7, 1, 6),
    'check_read': (16, 6, 0, 0),
    'check_nord': (0, 0, 1, 0),
    'check_readi': (17, 0, 0, 0),
}
for name, (rd, old, we, new) in expected.items():
...
print('PASS: 6 CSR forms, read-only register/immediate, rd=x0, illegal write; GPR and CSR fields match')
