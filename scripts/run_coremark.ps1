...
$summary = @(
  ...
  "  queue zero / partial : $($performanceProfile.frontend_empty_queue_zero_cycles) / $($performanceProfile.frontend_empty_partial_instruction_cycles)",
  "Target-buffer hits    : $($performanceProfile.target_buffer_hits) / $($performanceProfile.predicted_redirects) predicted redirects",
  "Redirect refill empty : $($performanceProfile.redirect_refill_empty_cycles)",
